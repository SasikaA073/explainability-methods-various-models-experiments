...
full_train_dataset = DataClass(split='train', transform=data_transform, download=download, root=data_path, size=224, mmap_mode='r')
full_val_dataset = DataClass(split='val', transform=data_transform, download=download, root=data_path,size=224, mmap_mode='r')
full_test_dataset = DataClass(split='test', transform=data_transform, download=download, root=data_path,size=224, mmap_mode='r')
...
if isinstance(test_dataset, torch.utils.data.Subset):
    ...
    evaluator.ground_truth = full_test_dataset.labels[subset_indices]
else:
    evaluator.ground_truth = test_dataset.labels
